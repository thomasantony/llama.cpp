...
TOKENIZER_FILENAME = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../llama.cpp/models/tokenizer.model")
VOCAB_SIZE = 32000
...
WEIGHTS_FILENAME = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../llama.cpp/models/7B/consolidated.00.pth")

# TODO: make this model work
args_13B = {"dim": 5120, "multiple_of": 256, "n_heads": 40, "n_layers": 40, "norm_eps": 1e-06, "vocab_size": VOCAB_SIZE}
WEIGHTS0_FILENAME = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../llama.cpp/models/13B/consolidated.00.pth")
WEIGHTS1_FILENAME = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../llama.cpp/models/13B/consolidated.01.pth")
